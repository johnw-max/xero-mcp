...
.intro{padding:30px 32px 24px;text-align:center;border-bottom:1px solid var(--line)}.provider-mark{width:118px;height:58px;margin:0 auto 18px;display:flex;align-items:center;justify-content:center;padding:14px 16px;background:#fff;border:1px solid var(--line);border-radius:16px;box-shadow:0 8px 24px rgba(32,72,60,.08)}.provider-mark img{display:block;width:100%;height:100%;object-fit:contain}
...
@media(max-width:700px){.page{padding:24px 12px 26px}.product-brand{margin-bottom:18px}.card{border-radius:20px}.intro{padding:24px 20px 20px}.provider-mark{width:110px;height:54px;margin-bottom:15px}.intro h1{font-size:25px}.description{font-size:13px}.main-content{padding:20px}.organisation{min-height:58px;padding:11px 13px}.scope-card{margin-top:18px;padding-top:16px}.footnote{margin-top:13px}}
